          ...
          <div class="item-details-with-actions">
            <div class="item-details">
              ...
              <p class="on-backorder-status" v-else> 
                <i class="fa-solid fa-hourglass"></i> On backorder
              </p>
          </div>
          <div class="item-actions">
            <div class="quantity-selector">
                ...
                <input 
                    ...
                    v-model="shoppingCartItems[0].quantity"
                    aria-label="quantity">
              ...
              <div class="item-actions">
                <div class="quantity-selector">
                  ...
                  <input 
                    type="text" 
                    class="quantity-input" 
                    v-model="shoppingCartItems[1].quantity"
                    aria-label="quantity">
                  ...
                  <div class="item-actions">
                      <div class="quantity-selector">
                          ...
                          <input 
                            type="text" 
                            class="quantity-input" 
                            v-model="shoppingCartItems[2].quantity"
                            aria-label="quantity">
                  ...
                  <div class="item-actions">
                      <div class="quantity-selector">
                          ...
                          <input 
                            type="text" 
                            class="quantity-input" 
                            v-model="shoppingCartItems[3].quantity"
                            aria-label="quantity">
                  ...
                  <div class="item-actions">
                      <div class="quantity-selector">
                          ...
                          <input 
                            type="text" 
                            class="quantity-input" 
                            v-model="shoppingCartItems[4].quantity"
                            aria-label="quantity">
