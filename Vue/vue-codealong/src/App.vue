...
function changeImg() {
  if (imageUrl.value === 'public/img/banner_1.jpg') {
    imageUrl.value = 'public/img/banner_2.jpg'
    return
  }
  else if (imageUrl.value === 'public/img/banner_2.jpg') {
    imageUrl.value = 'public/img/banner_3.jpg'
    return
  }
  else {
    imageUrl.value = 'public/img/banner_1.jpg'
    return
  }
}
